...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({
  ...
  return (
    <article className="relative group bg-transparent bg-[#1A103F]/80 rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer h-[500px]">
      {/* Background Image */}
