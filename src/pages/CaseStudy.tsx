      ...
      <section className="relative w-full pt-[160px] pb-16 max-xl:pt-[152px] max-lg:pt-[136px] max-md:pt-[120px] max-sm:pt-[100px] max-sm:pb-12 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                 ...
                 {/* Impact */}
                 <div>
                  <h2 className="text-2xl font-bold text-[#EAE8F3] mb-2 font-hagrid">Impact</h2>
                   <ul className="list-disc list-outside text-[#EAE8F3]/90 leading-relaxed space-y-3 ml-6 pl-2">
                    <li>
                ...
                {/* Role */}
                <div>
                  <h2 className="text-2xl font-bold text-[#EAE8F3] mb-2 font-hagrid">My role</h2>
                  <p className="text-[#EAE8F3]/90 leading-relaxed">
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative w-full">
                  <img 
                    src={`${import.meta.env.BASE_URL}QB_cover_dark.png`} 
        ...
        <div className="max-w-[1440px] w-full mx-auto my-0 max-md:max-w-[991px] max-sm:max-w-screen-sm bg-transparent relative z-10">
          ...
          <section className="mb-24">
            ...
            <div className="space-y-4">
            <p className="text-[#EAE8F3]/90 text-lg mt-6">
            ...
            <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
          ...
          <section className="mb-24">
            ...
            {/* Building alignment */}
            <div className="mb-12">
              <h3 className="text-[#EAE8F3] text-2xl font-bold mb-6">Building alignment</h3>
              ...
              <p className="text-[#EAE8F3]/90 text-md mb-6"> After many back and forth sessions during the week long design sprint, then making my case further up the chain with managers and VPs, the streamlined onboarding flow was born! The final version of this flow cut the number of questions we asked users in half, and added additional access points to ask setup questions in the right time and place, throughout the product - rather than grilling the user up front: </p>
            ...
            {/* Designing with AI */}
            <div className="mb-12">
              <h3 className="text-[#EAE8F3] text-2xl font-bold mb-6">Knowing when AI adds value</h3>
              <p className="text-[#EAE8F3]/90 text-lg mb-6">
            ...
            {/* Testing */}
            <div className="mb-12">
              <h3 className="text-[#EAE8F3] text-2xl font-bold mb-6">Testing & iteration</h3>
              <p className="text-[#EAE8F3]/90 text-lg mb-6">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white/20 border border-white/10 rounded-3xl shadow-xl p-12">
                ...
                <div className="relative">
                  ...
                  />
                  <p className="text-[#EAE8F3]/90 text-2xl pl-28 pt-2 mb-2">It feels like I've been here forever. Jeez, if I wasn't getting paid for this, <b>I would've given up a long time ago</b>"</p>
                  <p className="text-[#EAE8F3]/90 text-xl pl-28 pt-2">– User 16, an independent business consultant in Canada </p>
                </div>
              </div>
              ...
              <div className="bg-white/20 border border-white/10 rounded-3xl shadow-xl p-12">
                ...
                <div className="relative">
                  <img 
                    ...
                    className="absolute top-8 left-2 w-16 h-16 opacity-60"
                  />
                  <p className="text-[#EAE8F3]/90 text-2xl pl-28 pt-2 mb-2">Overall <b> setting up QuickBooks was easy, it was terrific.</b> The best thing that you did was just to go ahead and tell me how many hours I saved. Fabulous… This is a great setup—A+."</p>
                  <p className="text-[#EAE8F3]/90 text-xl pl-28 pt-2">- User 23, runs a coffee shop in Seattle </p>
                </div>
              </div>
             </div>

             <p className="text-[#EAE8F3]/90 text-lg mb-6"> We measured success on these usability tests three ways: average time to complete, sentiment analysis of quotes, and the ansswers to two key questions</p>
            <ol className="list-decimal list-outside text-[#EAE8F3]/90 text-lg space-y-3 ml-6 pl-2">
             ...
             <p className="text-[#EAE8F3]/90 text-lg mb-6"> The results of the test spoke for themselves - usability of the new flow was undeniably better than the control, and we had strong confidence that we were solving the right problems with the new design direction.</p>
          ...
          {/* Final touches */}
          <div className="mb-12">
            <h3 className="text-[#EAE8F3] text-2xl font-bold mb-6">Final touches 🪄</h3>
            <p className="text-[#EAE8F3]/90 text-lg mb-6"> To shoot for that perfect usability score in the real experiment, I took each key pain point above, and ideated, prototyped, and brought solutions to design critique before settling on the most comprehensive ones: </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="relative bg-green-950/20 p-6 rounded-2xl overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-[#EAE8F3]/90 text-lg">Add tooltips on fields that frequently elicited questions during user testing. Build these on the basis of progressive disclosure, so that users who aren't confused can continue without being slowed down.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="relative bg-green-950/20 p-6 rounded-2xl overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-[#EAE8F3]/90 text-lg"> Worked with 2 motion designers over the span of a month to create an updated welcome screen, and loading screens that give an overview of the many things QuickBooks can do</p>
                  </div>
                </div>
              </div>
                  <div className="bg-white/5 rounded-2xl p-4 mb-6">
          ...
          {/* Final Design */}
          <section className="mb-24">
            <h2 className="text-[#EAE8F3] text-[32px] font-bold mb-8 font-hagrid">Final Design</h2>
            <p className="text-[#EAE8F3]/90 text-lg mb-6">
            ...
            <p className="text-[#EAE8F3]/90 text-lg">
                ...
                <div className="bg-gray-50 bg-white/5 rounded-2xl p-4 mb-6">
                 ...
                 <p className="text-[#EAE8F3]/90 text-lg mb-6">As noted in the beginning of this case study, this was one of the most successful tests our team has ever run. It achieved its goal of reducing cognitive load, as evidenced by:</p>
                 
                 <ul className="list-disc list-outside text-[#EAE8F3]/90 text-lg space-y-3 ml-6 pl-2 mb-6">
