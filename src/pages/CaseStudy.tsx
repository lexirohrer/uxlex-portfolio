...
const CaseStudy = () => {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-100 via-indigo-50 to-blue-200 dark:bg-[#1A103F] w-full py-16 max-sm:py-12 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                 ...
                 {/* Impact */}
                 <div>
                  <h2 className="text-2xl font-bold text-gray-800 dark:text-[#EAE8F3] mb-2 font-hagrid">Impact</h2>
                   <ul className="list-disc list-outside text-gray-700 dark:text-[#EAE8F3]/90 leading-relaxed space-y-3 ml-6 pl-2">
                    <li>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative w-full">
                  <img 
                    src={`${import.meta.env.BASE_URL}${theme === 'dark' ? 'QB_cover_dark.png' : 'QB cover.png'}`} 
        ...
        <div className="max-w-[1440px] w-full mx-auto my-0 max-md:max-w-[991px] max-sm:max-w-screen-sm bg-white dark:bg-transparent">
          ...
          <section className="mb-16">
            ...
            {/* Building alignment */}
            <div className="mb-12">
              <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-6">Building alignment</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div className="bg-[#E6F0F7] dark:bg-white/10 p-6 rounded-2xl">
                  ...
                  <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-3">Listening</h4>
                  <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-md">Each team shared their goals and why their step had been added.</p>
                </div>
                ...
                <div className="bg-[#E6F0F7] dark:bg-white/10 p-6 rounded-2xl">
                  ...
                  <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-3">Showing evidence</h4>
                  <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-md">I shared data on the 18-minute average onboarding time. Then, <b> we watched recordings of people cursing, huffing, and struggling through the flow.</b></p>
                </div>
                ...
                <div className="bg-[#E6F0F7] dark:bg-white/10 p-6 rounded-2xl">
                  ...
                  <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-3">Finding Shared Goals</h4>
                  <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-md">Together, we agreed that the primary goal of onboarding should be to get users to value quickly, not to maximize every team's KPIs.</p>
                </div>
                ...
                <div className="bg-[#E6F0F7] dark:bg-white/10 p-6 rounded-2xl">
                  ...
                  <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-3">Co-designing</h4>
                  <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-md ">Now aligned on shared principles, each team sketched the leanest possible flow <i>they</i> could think of. We aligned these visions, and deferred other setup tasks to contextual moments later in the product.</p>
                </div>
              </div>
              <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-md mb-6"> After many back and forth sessions during the week long design sprint, then making my case further up the chain with managers and VPs, the streamlined onboarding flow was born! The final version of this flow cut the number of questions we asked users in half, and added additional access points to ask setup questions in the right time and place, throughout the product - rather than grilling the user up front: </p>
            ...
            {/* Designing with AI */}
            <div className="mb-12">
              <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-6">Knowing when AI adds value</h3>
              <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg mb-6">
              ...
              Past customer surveys showed that 75% of QuickBooks customers had websites, which already contained much of the information needed to create their account — things like business name, email, industry, and branding. Alongside my engineers, we designed an AI import flow that allowed users to scrape data from their public website, rather than importing it manually. <b> With one click, QuickBooks generated a business profile pre-filled with all the user's information we had pulled, which users could then confirm or edit.</b>
               ...
               <div className="bg-gray-50 dark:bg-white/5 dark:bg-white/5 rounded-2xl p-4 mb-6">
                 <video 
                   ref={videoRef}
            ...
            {/* Testing */}
            <div className="mb-12">
              <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-6">Testing & iteration</h3>
              <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg mb-6">
            ...
            <ol className="list-decimal list-outside text-[#403930] dark:text-[#EAE8F3]/90 text-lg space-y-3 ml-6 pl-2">
             ...
             <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg mb-6"> The results of the test spoke for themselves - usability of the new flow was undeniably better than the control, and we had strong confidence that we were solving the right problems with the new design direction.</p>
          ...
          {/* Final touches */}
          <div className="mb-12">
            <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-6">Final touches 🪄</h3>
            <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg mb-6"> To shoot for that perfect usability score in the real experiment, I took each key pain point above, and ideated, prototyped, and brought solutions to design critique before settling on the most comprehensive ones: </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg">
                ...
                <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-4 mb-6">
                 ...
                 <p className="text-[#403930] dark:text-[#EAE8F3]/90 text-lg mb-6">As noted in the beginning of this case study, this was one of the most successful tests our team has ever run. It achieved its goal of reducing cognitive load, as evidenced by:</p>
                 
                 <ul className="list-disc list-outside text-[#403930] dark:text-[#EAE8F3]/90 text-lg space-y-3 ml-6 pl-2 mb-6">
