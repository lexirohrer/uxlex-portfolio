...
const MuvMiCaseStudy = () => {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-green-100 via-emerald-50 to-green-200 dark:bg-[#1A103F] w-full py-16 max-sm:py-12 overflow-hidden">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="bg-white dark:bg-white/10 bg-opacity-20 text-gray-800 dark:text-[#EAE8F3] border border-gray-200 dark:border-white/10 px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm shadow-sm">
        ...
        <div className="max-w-[1440px] w-full mx-auto my-0 max-md:max-w-[991px] max-sm:max-w-screen-sm bg-white dark:bg-[#1A103F]">
          ...
          <section className="mb-0">
            <h2 className="text-[#403930] dark:text-[#EAE8F3] text-[32px] font-bold mb-8 font-hagrid">Why Participatory Design?</h2>
            ...
            <p className="text-[#403930] dark:text-[#EAE8F3] text-lg mb-6">
              ...
              <div className="bg-gray-100 dark:bg-white/5 rounded-2xl p-4 mb-6">
                <div className="relative">
                  ...
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-2xl pl-6 pt-2 mb-2">People [in Thailand] think that 'user-first' just means you're thinking about the user and what they would want — but it's actually about being with the user, talking to them, and hearing them speak for themselves about what they want. This isn't well understood yet here.</p>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-xl pl-6 pt-2">— Thai CEO, Stanford HCI graduate (Interview, 06/12/2025)</p>
                </div>
              </div>
              <p className="text-[#403930] dark:text-[#EAE8F3] text-lg mb-6"> 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              {/* Project Goals Card */}
              <div className="bg-white dark:bg-white/10 rounded-2xl shadow-md overflow-hidden">
                <div className="bg-[#E6F0F7] dark:bg-white/10 p-6">
                  <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold font-hagrid">
                    Project Goals
                  </h3>
                </div>
                <div className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-[#403930] dark:text-[#EAE8F3] text-lg text-base">
           ...
           <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-green-50 dark:bg-green-950/20 p-6 rounded-2xl">
                ...
                <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-regular mb-3">Local users choose MuvMi Tuk Tuks <strong>because they are safer</strong> than other travel methods (e.g. motorbikes, walking, etc.)</h4>
              </div>
          ...
          <section className="mb-16">
            ...
            <p className="text-[#403930] dark:text-[#EAE8F3] text-lg space-y-3 ml-6 pl-2 mb-6"> Across the 4 sets of tourists, these ride alongs generated many key insights, with the most notable being:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-green-50 dark:bg-green-950/20 p-6 rounded-2xl">
                <div className="flex items-center justify-center w-12 h-12 bg-green-100 text-[#B38C28] rounded-full text-2xl font-bold mb-4">👍</div>
                <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-regular mb-3">Tourist users loved how <strong>safe, clean, and comfortable</strong> the vehicles were</h4>
                </div>

              <div className="bg-red-50 dark:bg-red-950/20 p-6 rounded-2xl">
                <div className="flex items-center justify-center w-12 h-12 bg-red-100 text-[#B38C28] rounded-full text-2xl font-bold mb-4">👎</div>
                <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-regular mb-3">Tourist users <strong>struggled the most with the checkout flow</strong>, with key UI issues preventing them from success</h4>
              </div>
              
              <div className="bg-red-50 dark:bg-red-950/20 p-6 rounded-2xl">
                <div className="flex items-center justify-center w-12 h-12 bg-red-100 text-[#B38C28] rounded-full text-2xl font-bold mb-4">👎</div>
                <h4 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-regular mb-3">Tourist users were <strong>confused</strong> why they could only go <strong>limited distances</strong> in the Tuk Tuks</h4>
              </div>
            </div>
            <p className="text-[#403930] dark:text-[#EAE8F3] text-lg space-y-3 ml-6 pl-2 mb-6"> The safety, cleanliness, and comfort of the Tuk Tuk rides was a major highlight - but there were two key areas for improvement in the app experience. Firstly, the UI of the checkout was unintuitive - issues like selection components and text hierarchy created a confusing flow, and add on options like "include hotel pickup" didn't tell the user that hotel pickup needed to be booked 30 minutes in advance.
            </p>
              <img
          ...
          <section className="mb-16">
            ...
            <h3 className="text-[#403930] dark:text-[#EAE8F3] text-2xl font-bold mb-6">Design recommendations</h3>
              <p className="text-[#403930] dark:text-[#EAE8F3] text-lg mb-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-4">
                  <div className="w-2 h-2 bg-[#557592] dark:bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-lg">Visual travel zones displayed directly on the map, to juggle the tourist "ride-hailing" mental model with the local "gas Tuk Tuk" mental model</p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-2 h-2 bg-[#557592] dark:bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-lg">A switchable tourist vs. local mode within the same app.</p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-2 h-2 bg-[#557592] dark:bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-lg">Expanded radius for tourists willing to pay more.</p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-2 h-2 bg-[#557592] dark:bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-lg">Improving usability of the checkout flow for tourists</p>
              </div>
                <div className="flex items-start gap-4">
                  <div className="w-2 h-2 bg-[#557592] dark:bg-[#EAE8F3] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-[#403930] dark:text-[#EAE8F3] text-lg">Implementing convenience features like "saved places" that would increase user adption for locals and ease first time use for tourists</p>
              </div>
              </div>
            <img
        ...
        {/* Methodology Learnings */}
          ...
          <div className="bg-gray-100 dark:bg-white/5 rounded-2xl p-4 mb-6">
            <div className="relative">
              ...
              <p className="text-[#403930] dark:text-[#EAE8F3] text-2xl pl-6 pt-2 mb-2">Activities like paper prototyping felt like another layer — the user has to think deeper on what they want and why, instead of just tell us what they don't like.</p>
              <p className="text-[#403930] dark:text-[#EAE8F3] text-xl pl-6 pt-2">— MuvMi Employee (Interview, 04/08/2025)</p>
            </div>
          </div>
          ...
          <div className="bg-gray-100 dark:bg-white/5 rounded-2xl p-4 mb-6">
            <div className="relative">
              <span className="absolute -top-2 -left-2 text-6xl text-[#557592] dark:text-[#EAE8F3]/70 leading-none opacity-60" style={{ fontFamily: 'Holtwood One SC, serif' }}>"</span>
              <p className="text-[#403930] dark:text-[#EAE8F3] text-2xl pl-6 pt-2 mb-2">You not only remember what the users say, but what they felt about it at the time… you can truly trust what they say because you can see their frustration or happiness.</p>
              <p className="text-[#403930] dark:text-[#EAE8F3] text-xl pl-6 pt-2">— MuvMi Employee (Interview, 04/08/2025)</p>
            </div>
            </div>
          </section>
