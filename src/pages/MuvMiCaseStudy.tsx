              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="bg-white bg-white/10 bg-opacity-20 text-gray-800 text-[#EAE8F3] border border-gray-200 border-white/10 px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm shadow-sm">
